...
class upMahasiswa extends StatefulWidget {
  const upMahasiswa({Key? key}) : super(key: key);

  @override
  State<upMahasiswa> createState() => _upMahasiswaState();
}

class _upMahasiswaState extends State<upMahasiswa> {
  ...
  Future<List> updateMhs(int id, String nama, String nim, String email,
    ...
    final http.Response response = await http.post(
      Uri.parse(
          'https://kpsi.fti.ukdw.ac.id/api/progmob/mhs/update?id=$id&nim_progmob=72200425'),
