...
import 'package:flutter_application_3/mahasiswa/mahasiswa_add.dart';
import 'package:flutter_application_3/mahasiswa/mahasiswa_up.dart';
  ...
  Future _getDataMhs() async {
    try {
      final response = await http.get(
          Uri.parse("https://kpsi.fti.ukdw.ac.id/api/progmob/mhs/72200425"));
